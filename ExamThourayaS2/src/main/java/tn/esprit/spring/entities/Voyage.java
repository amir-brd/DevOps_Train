...
public class Voyage  implements Serializable {
	...
	public Voyage(long idVoyage, long codeVoyage, Ville gareDepart, Ville gareArrivee, Date dateDepart, Date dateArrivee, double heureDepart, double heureArrivee) {
		this.idVoyage = idVoyage;
		this.codeVoyage = codeVoyage;
		this.gareDepart = gareDepart;
		this.gareArrivee = gareArrivee;
